...
<nav className="bg-white border-gray-200 dark:bg-gray-900 ">
  ...
  <a href="/" className="flex items-center space-x-3 rtl:space-x-reverse">
      <img src="/src/images/logo.png" className="h-8 rounded-xl" alt="Flowbite Logo" />
  ...
  <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-user">
    <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
      <li>
            <NavLink  onClick={()=>context.setSearchByCategory()} to='/' className ={({isActive})=> `block py-2 px-3 text-white bg-blue-700 rounded-sm md:bg-transparent md:text-blue-700 md:p-0 md:dark:text-blue-500  ${isActive ? activeStyle: undefined}  `}>
                    Todo
            </NavLink>
      </li>
      {
