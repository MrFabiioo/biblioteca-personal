...
<nav className="bg-blue-200 border-gray-200 dark:bg-gray-900 ">
  ...
  <div className={`items-center justify-between w-full md:flex md:w-auto md:order-1 ${menuVisible ? "" : "hidden"}`} id="navbar-user">
