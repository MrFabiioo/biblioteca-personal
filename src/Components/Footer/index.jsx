...
<footer className="bg-white  shadow-sm dark:bg-gray-900 mt-auto">
    <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
        ...
        <span className="font-mono block text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2025 <a href="https://flowbite.com/" className="hover:underline">Jose Fabio Ortega Estrada™</a>. Todos los derechos reservados.</span>
    </div>
</footer>
    );
}
