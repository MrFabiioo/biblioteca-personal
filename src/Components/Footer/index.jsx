...
function Footer(){
    ...
    return(
        isAuthenticated &&
<footer className="bg-blue-200  shadow-sm dark:bg-gray-900 mt-auto">
    <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
        <div className="sm:flex sm:items-center sm:justify-between">
            ...
            <ul className="flex flex-wrap items-center aling-center mb-6 text-sm font-medium text-black sm:mb-0 dark:text-gray-400">
                <li>
        ...
        <span className="font-mono block text-sm text-black sm:text-center dark:text-gray-400">© 2025 <a href="#" className="hover:underline">Jose Fabio Ortega Estrada™</a>. Todos los derechos reservados.</span>
    </div>
</footer>
    );
}
